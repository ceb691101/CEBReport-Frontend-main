...
const cards: DashboardCardItem[] = [
  { icon: <Target className="w-5 h-5 text-blue-600" />, bgClassName: "bg-blue-100", label: "Strategic KPI Score", value: "84.2%", badge: "+3.2%" },
  { icon: <TrendingUp className="w-5 h-5 text-green-600" />, bgClassName: "bg-green-100", label: "Revenue Growth", value: "11.7%", badge: "+1.6%" },
  { icon: <Users className="w-5 h-5 text-purple-600" />, bgClassName: "bg-purple-100", label: "Customer Satisfaction", value: "4.6/5", badge: "+0.2" },
  { icon: <AlertCircle className="w-5 h-5 text-amber-600" />, bgClassName: "bg-amber-100", label: "Critical Risks", value: "7", badge: "-2" },
];

const ExecutiveDashboardPage: React.FC = () => {
  const navigate = useNavigate();
  const activeDashboard = "executive";
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="flex">
        ...
        <div className="flex-1">
          <DashboardHeader title="Executive/KPI Dashboard" />
          <div className="p-8">
